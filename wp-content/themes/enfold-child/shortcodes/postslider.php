                    ...
                    if (!empty($title))
                    {
	                    if($show_meta)
	                    {
			                ...
			                if(!empty($cats))
		                    {
		                        ...
		                        $output .= apply_filters( 'taxonomy-images-list-the-terms', '', array(
                              'after_image' => $cats, 'post_id' => $the_id ) );
		                        $output .= '</span>';
		                    }
	                    }
	                    
                    	$output .=  "<h1 class='slide-entry-title entry-title' $markup><a href='{$link}' title='".esc_attr(strip_tags($title))."'>".$title."</a></h1>";
